...
const Imobiliario = (props) => {
  const Data = [];

  const getData = () => {
    props.props.map((user) => {
      if (user.category === "imobiliario") {
        Data.push(user);
      }
    });
  };
      ...
      <Route
        ...
        render={() => (
          <div className={classes.wrapper}>
            <h2 className={classes.title}>РИЕЛТОРЫ</h2>
...
export default withRouter(Imobiliario);
